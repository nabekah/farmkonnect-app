...
export const FarmComparisonCharts: React.FC<FarmComparisonChartsProps> = ({ farms, startDate, endDate }) => {
  // Fetch financial data for each farm
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Side-by-side comparison of farm performance</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Profitability percentage by farm</CardDescription>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={comparisonData}>
              ...
              <Legend />
              <Line type="monotone" dataKey="margin" stroke="#8b5cf6" name="Profit Margin (%)" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Detailed metrics for each farm</CardDescription>
        </CardHeader>
        <CardContent>
...
export default FarmComparisonCharts;
